...
public class BasicDataStats {
    ...
    public double getRFlatHPRegenPerLevel() {
        return rFlatHPRegenPerLevel;
    }

    public void setRFlatHPRegenPerLevel(double rFlatHPRegenPerLevel) {
        this.rFlatHPRegenPerLevel = rFlatHPRegenPerLevel;
    }
