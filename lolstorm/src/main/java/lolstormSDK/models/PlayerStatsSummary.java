...
public class PlayerStatsSummary {
    ...
    public String toString() {
        return "PlayerStatsSummary [aggregatedStats=" + aggregatedStats + ", losses=" + losses + ", modifyDate=" + modifyDate + ", modifyDateStr=" + modifyDateStr + ", playerStatSummaryType=" + playerStatSummaryType + ", wins=" + wins + "]";
    }
