...
public class ResourceUtils {
    ...
    public static int numberedDrawableFromID(int id, Context context) {
        Resources resources = context.getResources();
        return resources.getIdentifier("_" + Integer.toString(id), DRAWABLE, context.getPackageName());
    }

    public static int tierDrawableFromTierAndDivision(String tier, String division, Context context) {
        Resources resources = context.getResources();
